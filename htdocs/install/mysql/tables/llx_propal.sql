...
(
  ...
  total_ht				    numeric(24,8) DEFAULT 0,			-- montant total ht apres remise globale
  tva					    numeric(24,8) DEFAULT 0,			-- montant total tva apres remise globale
  localtax1				    numeric(24,8) DEFAULT 0,			-- amount total localtax1
  localtax2				    numeric(24,8) DEFAULT 0,			-- amount total localtax2
  total					    numeric(24,8) DEFAULT 0,			-- montant total ttc apres remise globale
